...
namespace DataAbstraction.Interfaces
{
    public interface IMySqlSecVolumeRepository
    {
		...
		Task<List<SecCodeAndRealVolume>?> GetRealVolumeForSecCodesList(CancellationToken cancellationToken, List<string> extraBuySecCodes);
		...
		Task<List<PieChartItemModel>?> GetSharesVolumeChartData(CancellationToken cancellationToken, int year);
